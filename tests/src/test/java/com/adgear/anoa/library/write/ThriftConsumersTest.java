...
public class ThriftConsumersTest {
  ...
  public void testJackson() throws IOException {
    ...
    try (WriteConsumer<LogEventThrift> wc = ThriftConsumers.jacksonStrict(ATS.thriftClass, tb)) {
      ATS.thrift().forEach(wc);
    }
    ATS.assertThriftObjects(ThriftStreams.jacksonStrict(ATS.thriftClass, tb.asParser()));
  }
}
