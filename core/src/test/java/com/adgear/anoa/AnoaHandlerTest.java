...
public class AnoaHandlerTest {
  ...
  public void test() {
    ...
    Assert.assertNotNull(handler.wrap(null));
    Assert.assertEquals("derp", handler.wrap("derp").get());

    ListAssert.assertEquals(Collections.singletonList(Meta.RUNTIME),
                            handler.handle(new AnoaJacksonTypeException("hello")).meta()
  ...
  public void testSuppliers() {
    ...
    Assert.assertEquals(Anoa.of(null, Stream.of(Meta.OTHER)),
  ...
  public void testConsumers() {
    ...
    Assert.assertEquals(Anoa.of(1L), handler.consumer(lc::addAndGet).apply(handler.wrap(1L)));
    Assert.assertEquals(1L, lc.get());
    Assert.assertEquals(Anoa.of(null, Stream.of(Meta.OTHER)),
                        handler.consumerChecked(__ -> {
                          throw new IOException();
                        }).apply(handler.wrap(1L)));
  ...
  public void testFunctions() {
    ...
    Assert.assertEquals(Anoa.of(10L), handler.function(lf::getAndAdd).apply(handler.wrap(1L)));
  ...
  public void testPredicates() {
    Assert.assertEquals(Anoa.of(null, Stream.of(Meta.FAIL)),
